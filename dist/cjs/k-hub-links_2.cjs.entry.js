...
const kHubLinks = class {
    ...
    render() {
        let maincontent = this.linksList.map(link => (index.h("div", { key: '266b6927702938d5edd74ea973d71582d69aea66', onClick: this.launch.bind(this, link.url) }, link.title)));
        return [index.h("h1", { key: 'cb486d104050677c17378f8bda68f1bf071d544d' }, "Useful Links"), index.h("section", { key: 'e0df65544cf48ffb7f24c6946457849db78c903c' }, maincontent)
        ];
    }
};
...
const kHubTiles = class {
    ...
    render() {
        let maincontent = this.tilesList.map(tile => (index.h("div", { key: '9c76bee6c54af241f4e5f3960fc8f13fbcca3dc3', onClick: this.launch.bind(this, tile.url) }, index.h("strong", { key: 'b70ce49de8ea549d8d6cd83215cfeff68223c018' }, tile.title))));
        return [index.h("section", { key: '8cd985f21d65b3867481b09e16720adbddf51764' }, maincontent)
        ];
    }
};
kHubTiles.style = KHubTilesStyle0;

exports.k_hub_links = kHubLinks;
exports.k_hub_tiles = kHubTiles;

//# sourceMappingURL=k-hub-links_2.cjs.entry.js.map